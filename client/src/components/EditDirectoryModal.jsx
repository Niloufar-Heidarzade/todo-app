  ...
  return (
    <>
      ...
      <div className="z-60 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-gray-200 w-70 sm:w-90 h-46 rounded-sm py-5 px-4" ref={modalRef}>
        ...
        <input type="text" placeholder="Secondary" className="bg-gray-50 w-full h-9 rounded-sm pl-2 text-sm focus:outline-none focus:border-1 focus:border-violet-500" id="directory"/>
        <button className="bg-violet-500 text-white text-sm w-15 h-9 rounded-sm mt-5 cursor-pointer transform hover:bg-violet-700 duration-200 ">Edit</button>
      </div>
    </>
  );
}
