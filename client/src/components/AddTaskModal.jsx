    ...
    <>
      ...
      >
        <div className="flex justify-between">
          <p className="text-slate-700 font-medium text-lg dark:text-slate-300">Add a task</p>
          <svg
        ...
        <label htmlFor="date" className="block text-gray-600 dark:text-gray-400 text-sm mt-3">
          Date
        </label>
        <input
          id="date"
        ...
        <select id="directory" className="w-full h-10 bg-gray-100 px-3 rounded text-gray-700 outline-none focus:border-2 focus:border-violet-500 dark:bg-slate-600 dark:text-white" {...register("directory")}>
